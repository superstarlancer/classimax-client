                            ...
                            <div class="category-block">
                                <div class="header">
                                    <h4>
                                        ...
                                        {{ $category_all->name }} <p style="display: inline">({{ $category_all->companies->count() }})</p>
                                    </h4>
                                </div>
                                <ul class="category-list">
                                    @foreach ( $category_all->companies as $singleCompany)
                                        <!-- <li><a href="{{ route('company', [$singleCompany->id]) }}">{{ $singleCompany->name}} </a></li> -->
                                        <li><a href="#">{{ $singleCompany->name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div> <!-- /Category List -->               
